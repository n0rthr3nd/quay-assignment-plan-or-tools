...
def config_to_problem(config):
    ...
    for vc in config["vessels"]:
        v = Vessel(
            ...
            departure_deadline=get_dt(int(vc["departure_shift"]), 0),
